...
This public repository hosts Lenomila Shelf catalog metadata and public APK release assets for Tony's private Android app store.

Lenomila Shelf clients fetch `catalog/index.json`, verify its detached RSA/SHA-256 signature, show pinned APK SHA-256/signing metadata, and install GitHub-hosted APK downloads only through Android user consent.
...
Lenomila Shelf is a companion private Android app catalog for the same signed app collection. It focuses on browsing, sharing, checking updates, viewing release details, and installing verified GitHub-hosted APKs through Android's normal installer flow.

- Package: `com.lenomila.shelf`
- Category: `Catalog`
- Version: `0.3.14` / code `44`
- Description: Lenomila Shelf is a companion private Android app catalog for the same signed app collection. It focuses on browsing, sharing, checking updates, viewing release details, and installing verified GitHub-hosted APKs through Android's normal installer flow.
- Download: <https://github.com/yustein/LenomilaShelf/releases/download/lenomilashelf-v0.3.14/LenomilaShelf-v0.3.14.apk>
- APK SHA-256: `625956609f8cd7052d69171699ebed7d6653b3a2a5f6fb1dc03a0896a81dfe5c`
...
- Download: <https://github.com/yustein/LenomilaShelf/releases/download/auroraweather-v3.0.29/AuroraWeather-v3.0.29.apk>
...
- Download: <https://github.com/yustein/LenomilaShelf/releases/download/muzoplay-v0.1.24/MuzoPlay-v0.1.24.apk>
...
- Download: <https://github.com/yustein/LenomilaShelf/releases/download/uniwhisper-v0.1.1/UniWhisper-v0.1.1.apk>
...
- Download: <https://github.com/yustein/LenomilaShelf/releases/download/visitvideologger-v0.1.30/VisitVideoLogger-v0.1.30.apk>
